...
import { SlackTriggerDialog } from "./dialog";
import { useNodeStatus } from "@/features/executions/hooks/use-node-status";
import { useAtomValue } from "jotai";
import { workflowIdAtom } from "@/features/editor/store/atoms";

export const SlackTriggerNode = memo((props: NodeProps) => {
    ...
    const webhookUrl = workflowId
        ? `${baseUrl}/api/webhooks/slack/${workflowId}`
        : "";
    ...
    return (
        <>
            ...
            <BaseTriggerNode
                ...
                name="When Slack event is received"
...
SlackTriggerNode.displayName = "SlackTriggerNode";
