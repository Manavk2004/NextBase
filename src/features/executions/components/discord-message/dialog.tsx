...
export const DiscordMessageDialog = ({
    ...
    const credentialsQuery = useQuery(
        trpc.credentials.getByType.queryOptions({ type: "DISCORD" })
    );
        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent>
                <DialogHeader>
                    ...
                    <DialogDescription>Send a message to a Discord channel via webhook.</DialogDescription>
                </DialogHeader>
                <Form {...form}>
                    <form
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormDescription>
                                        Select a Discord webhook URL. <Link href="/credentials" className="underline">Manage credentials</Link>
                                    </FormDescription>
                                    <FormMessage />
                                </FormItem>
                            )}
